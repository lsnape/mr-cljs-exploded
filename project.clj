(defproject mrcljs "1.0.0-SNAPSHOT"
  :description "Mrcljs service"
  ...
  :profiles {:dev {:dependencies [[com.github.rest-driver/rest-client-driver "1.1.42"
                   ...
                   :repl-options {:init-ns mrcljs.repl}
  ...
  :rpm {:name "mrcljs"
        :summary "RPM for Mrcljs service"
        ...
        :mappings [{:directory "/usr/local/mrcljs"
                    :filemode "444"
                    :username "mrcljs"
                    :groupname "mrcljs"
                    :sources {:source [{:location "target/mrcljs.jar"}]}}
                   {:directory "/usr/local/mrcljs/bin"
                    :filemode "744"
                    :username "mrcljs"
                    :groupname "mrcljs"
                   ...
                   {:directory "/etc/rc.d/init.d"
                    :filemode "755"
                    :sources {:source [{:location "scripts/service/mrcljs"
                                        :destination "mrcljs"}]}}]}
